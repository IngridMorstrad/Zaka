...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "Snake.py"
 
        #Name of program
        self.project_name = "Zaka"
        ...
        self.license = "Python License"
 
        #Auhor of program
        self.author_name = "Ashwin Menon"
        self.author_email = "ashwin91+zaka@gmail.com"
        self.copyright = "Copyright (c) 2011 Ashwin Menon."
 
        #Description
        self.project_description = "A basic game in which you aim to catch points"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = None
 
        #Extra files/dirs copied to game
        self.extra_datas = ['HSS.txt', 'HSN.txt', 'food.jpg', 'bg.jpg', 'eat.wav', 'awh_man.wav', 'rhbattle.mid', 'bg1.jpg']
 
        #Extra/excludes python modules
        self.extra_modules = ['HSS']
